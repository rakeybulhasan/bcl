...
<div class="portlet box purple">
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-cogs"></i>Product Category List</div>
        <div class="actions">
            <a href="{{ URL::to('categories/add') }}" class="btn green"><i class="fa fa-plus"></i> Add Product Category</a>
     ...
     @if (Session::has('message'))
        ...
        <table class="table table-striped table-bordered table-hover" id="sample_3">
            ...
            <tr class="odd gradeX">
                ...
                <td> <a href="{{ URL::to('categories/update/'.$value->id)}}">Update</a></td>
                <td> <a href="{{ URL::to('categories/delete/'.$value->id)}}">Delete</a></td>
