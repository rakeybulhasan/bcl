...
<div class="col-md-12">
    ...
    <div class="portlet box purple">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            {{Form::model($data,array('action' => array('ClientSupplierController@postCheckupdate', $data->id), 'method' => 'post', 'class'=>'form-horizontal', 'id'=>'client_supplier_form'))}}
            <div class="form-body">
                ...
                <div class="form-group">
                    {{HTML::decode(Form::label('last_name','Last Name<span class="required">*</span>',array('class' => 'control-label col-md-3')))}}
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        {{Form::select('country_id', $country,$data->country_id, array('class'=>'form-control'))}}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        {{Form::select('group_id', array('1' => 'Client','2'=>'Supplier'),$data->group_id, array('class'=>'form-control') )}}
                    </div>
                </div>
