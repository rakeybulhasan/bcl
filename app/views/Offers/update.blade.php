...
<div class="col-md-12">
    ...
    <div class="portlet box purple">
        <div class="portlet-title">
            <div class="caption"><i class="fa fa-reorder"></i>Update Offer</div>
            <div class="actions">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            {{Form::model($offerdata,array('action' => array('OfferController@putCheckUpdate', $offerdata->id), 'files' => true,
            'method' => 'PUT', 'class'=>'form-horizontal', 'id'=>'offer_update_form'))}}
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="client_id" class="form-control select2" name="client_id">
                            ...
                            <option value="{{$value['id']}}" {{($value['id'] == $offerdata->client_id) ? 'selected="selected"' : '' }}>{{$value['first_name'].' '.$value['last_name']}}</option>
